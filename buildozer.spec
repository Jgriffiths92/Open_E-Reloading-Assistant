...
requirements = python3,kivy,kivymd,pyjnius,pillow,plyer
...
android.presplash_color = #fe9a79
...
icon.adaptive_foreground.filename = assets/images/icon_fg.png
icon.adaptive_background = #016586

# (list) Permissions
# (See https://python-for-android.readthedocs.io/en/latest/buildoptions/#build-options-1 for all the supported syntaxes and properties)
android.permissions = INTERNET, WRITE_EXTERNAL_STORAGE, READ_EXTERNAL_STORAGE, FOREGROUND_SERVICE, NFC, VIBRATE
